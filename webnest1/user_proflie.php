    ...
    <div class="row">
        <div class="col-md-4 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <img class="rounded-circle mt-5" width="100px" height="100px;" name="pro_image" src="profile_Image/<?php echo $img; ?>"><span class="font-weight-bold"><?php echo $name ; ?></span>
				...
				<div class="modal-content">
					...
					<a <?php 
						$rea=$_POST['reason'];
							...
							echo 'href="delete_user.php?user_id='.$userid.'&& res='.$rea.'  "';?> style=" background-color:#9f0707;padding:7px;width:20%;margin-left:80%;border-radius:7px; text-decoration:none;color:#fff;text-align:center;">Delete</a>
