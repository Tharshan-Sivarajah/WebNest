                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <table style="margin-top:3%; " >
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" checked="checked">  <font style="color:#CCCCCC;" size="1">  Keep me logged in </font>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <table style="margin-top:3%; ">
                                ...
                                <tr>
                                    <td>
                                        <a href="password-recovery.php" style="color:#CCCCCC; text-decoration:none;"><font size="1"> Forgot your password?</font> </a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <table style="margin-top:16%; ">
                                
                                <tr><td>
                                <input type="submit" name="Login" value="Log In" id="login_button" class="btm btn-info"> 
                                </td></tr>
                                <tr><td> </td></tr>
                            </table>
        ...
        <div class="row" style="margin-top:10.2%;">
            ...
            <div class="col-lg-6">
                     ...
                     <form  method="post" onSubmit="return check();" name="Reg">
                            ...
                            <div style="height:1; width:385; background-color:#CCCCCC;"><hr> </div>
                            <br>
                            <table width="70%">
                                <tr >
                                    <td align="right">
