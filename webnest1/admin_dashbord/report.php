...
<center>
	...
	<br><br>
	<br>
		<div  style="background:#222155;padding:1%;width:50%;   border-radius: 10px;">
            <h1 style="color:#fff;">Reports Information</h1>
        </div><br><br>
	<br><br>
...
if(isset($_POST['b1']))
{
	...
	$sql="SELECT * from report where r_id LIKE '%$id%' or report_uid LIKE '%$id%'  or post_id LIKE '%$id%' ORDER BY r_id DESC";
	...
	if(mysqli_num_rows($res)==0)
	 	...
	 	else
	 	{
			...
			echo "<center><table class=table><tr><th>Report Id</th><th>User Id</th><th>Report userid</th><th>E-mail</th><th>Report</th><th>Post Id</th><th>Date</th></tr>";
