...
<div class="page-flex">
            ...
            <ul class="sidebar-body-menu">
                ...
                <li>
                    ...
                    <ul class="cat-sub-menu">
                        ...
                        <li>
                            <a href="post_details.php">Post Details</a>
                        </li>
                ...
                <li>
                    ...
                    <span class="icon document" aria-hidden="true"></span>Report &nbsp<div><span style="background-color:#cd1e4b;padding:8px;border-radius:20px;" id="re-count">0</span></div>    
                    </a>
  ...
  <div class="main-wrapper">
    <!-- ! Main nav -->
    <nav class="main-nav--bg" style=" width:100%;" >
  <div class="container main-nav">
    <div class="main-nav-start">
        <span style="font-size:25px;color:#834aff"><b>Add Admin</b></span>
    </div>
