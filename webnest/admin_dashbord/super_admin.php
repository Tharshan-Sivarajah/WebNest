    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                ...
                <li>
                    ...
                    <ul class="cat-sub-menu">
                        ...
                        <li>
                            <a href="../admin_dashbord/post_details.php">Posts Details</a>
                        </li>
            ...
            <ul class="sidebar-body-menu">
                ...
                <li>
                      <!-- <a class="show-cat-btn" href="admin_info.php">
                          <span class="icon document" aria-hidden="true"></span>Admin Info
                          <span class="category__btn transparent-btn" title="Open list">
                              <span class="sr-only">Open list</span>
                              <span class="icon arrow-down" aria-hidden="true"></span>
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container" >
        ...
        <div class="row stat-cards">
          <div class="col-md-6 col-lg-4" style="margin-left:10%;">
            <article class="stat-cards-item" style="background-color:#222155;">
              <div class="stat-cards-icon warning">
                <i data-feather="bar-chart-2" aria-hidden="true"></i>
              </div>
              <div class="stat-cards-info">
                <p class="stat-cards-info__num"  style="color:#fff;">
                  <?php
                   ...
                   $row= mysqli_fetch_array($res);
                    echo $row[0] ;
                   ?></p>
                <p class="stat-cards-info__title"  style="color:#fff;">Total user</p>
          ...
          <div class=" col-lg-4" style="margin-left:5%;">
            <article class="stat-cards-item" style="background-color:#222155;">
              ...
              <div class="stat-cards-info">
                ...
                <p class="stat-cards-info__title"  style="color:#fff;">Total post</p>
                <p class="stat-cards-info__progress">
                  <span class="stat-cards-info__profit success">
            ...
            <article class="stat-cards-item" style="background-color:#222155;">
              ...
              <div class="stat-cards-info">
                ...
                <?php
                   ...
                   $sql="SELECT COUNT(rating_action) FROM post_like where rating_action='like' ";
                   $res=mysqli_query($conn,$sql);
                ...
                <p class="stat-cards-info__title"  style="color:#fff;">Total Likes</p>
                <p class="stat-cards-info__progress">
                  <span class="stat-cards-info__profit success">
                    <i data-feather="trending-up" aria-hidden="true"></i>0.24%
                  </span>
            ...
            <article class="stat-cards-item" style="background-color:#222155;">
              ...
              <div class="stat-cards-info">
                ...
                <?php
                   ...
                   $sql="SELECT COUNT(com_id) FROM com";
                   $res=mysqli_query($conn,$sql);
                ...
                <p class="stat-cards-info__title"  style="color:#fff;">Total comments</p>
                <p class="stat-cards-info__progress">
                  <span class="stat-cards-info__profit success">
                    <i data-feather="trending-up" aria-hidden="true"></i>0.24%
                  </span>
