...
include '../db-connect.php';
	...
	$sql="SELECT user_id,Name,Email,Gender,Birthday_Date,FB_join_Date from users where user_id LIKE '%$id%' or Name LIKE '%$id%' AND Password !=''";
	...
	if(mysqli_num_rows($res)==0)
	 	...
	 	else
	 	{
			...
			echo "<center><table class=table><tr><th>User_ID</th><th>Name</th><th>E-mail</th><th>Gender</th><th>DOB</th><th>Joined_Date</th><th>Operation</th></tr>";
