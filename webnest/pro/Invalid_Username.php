...
<div>
		...
		<form  method="post">
			...
			<div style="position:absolute; left:43.5%; top:57%; font-size:11px; "> <input type="text" name="username" style="width:174;" required/> </div>
			<div style="position:absolute; left:35.5%; top:62.2%; font-size:15; color:#fff;"> Password: </div>
			<div style="position:absolute;left:43.5%; top:62%; font-size:11px; "> <input type="password" name="password" style="width:174;" required> </div>
